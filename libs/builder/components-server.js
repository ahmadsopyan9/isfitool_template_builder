Isfitool.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


Isfitool.Components.add("components/product", {
    name: "Product",
...
Isfitool.Components.add("components/products", {
    name: "Products",
...
Isfitool.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
Isfitool.Components.add("components/categories", {
    name: "Categories",
...
Isfitool.Components.add("components/search", {
    name: "Search",
...
Isfitool.Components.add("components/user", {
    name: "User",
...
Isfitool.Components.add("components/product_gallery", {
...
Isfitool.Components.add("components/cart", {
    name: "Cart",
...
Isfitool.Components.add("components/checkout", {
    name: "Checkout",
...
Isfitool.Components.add("components/filters", {
    name: "Filters",
...
Isfitool.Components.add("components/slider", {
    name: "Slider",
