Isfitool.BlocksGroup['Bootstrap 4 Snippets'] =
...
Isfitool.Blocks.add("bootstrap4/signin-split", {
    name: "Modern Sign In Page with Split Screen Format",
	dragHtml: '<img src="' + Isfitool.baseUrl + 'icons/product.png">',    
...
Isfitool.Blocks.add("bootstrap4/image-gallery", {
    name: "Image gallery",
...
Isfitool.Blocks.add("bootstrap4/slider-header", {
...
Isfitool.Blocks.add("bootstrap4/video-header", {
    name: "Video Header",
	dragHtml: '<img src="' + Isfitool.baseUrl + 'icons/image.svg">',        
...
Isfitool.Blocks.add("bootstrap4/about-team", {
...
Isfitool.Blocks.add("bootstrap4/portfolio-one-column", {
...
Isfitool.Blocks.add("bootstrap4/portfolio-two-column", {
...
Isfitool.Blocks.add("bootstrap4/portfolio-three-column", {
...
Isfitool.Blocks.add("bootstrap4/portfolio-four-column", {
