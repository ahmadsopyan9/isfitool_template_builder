...
Isfitool.ComponentsGroup['Bootstrap 4'] =
...
//display
Isfitool.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
Isfitool.Components.extend("_base", "html/container", {
...
Isfitool.Components.extend("_base", "html/heading", {
...
Isfitool.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
...
Isfitool.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Isfitool.baseUrl + 'icons/image.svg" height="128" width="128">',
    /*
...
Isfitool.Components.add("html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
Isfitool.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
Isfitool.Components.extend("_base", "html/button", {
...
Isfitool.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
...
Isfitool.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
...
Isfitool.Components.extend("_base","html/alert", {
    classes: ["alert"],
    name: "Alert",
...
Isfitool.Components.extend("_base", "html/badge", {
    classes: ["badge"],
...
Isfitool.Components.extend("_base", "html/card", {
    classes: ["card"],
...
Isfitool.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: "icons/list_group.svg",
    classes: ["list-group"],
    html: '<ul class="list-group">\n  <li class="list-group-item">\n    <span class="badge">14</span>\n    Cras justo odio\n  </li>\n  <li class="list-group-item">\n    <span class="badge">2</span>\n    Dapibus ac facilisis in\n  </li>\n  <li class="list-group-item">\n    <span class="badge">1</span>\n    Morbi leo risus\n  </li>\n</ul>'
});
Isfitool.Components.extend("_base", "html/listitem", {
    name: "List Item",
    classes: ["list-group-item"],
    html: '<li class="list-group-item"><span class="badge">14</span> Cras justo odio</li>'
});
Isfitool.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
...
Isfitool.Components.extend("_base", "html/breadcrumbitem", {
...
Isfitool.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
...
Isfitool.Components.extend("_base", "html/pageitem", {
	classes: ["page-item"],
...
Isfitool.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
...
Isfitool.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
...
Isfitool.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
...
Isfitool.Components.extend("_base", "html/form", {
    nodes: ["form"],
...
Isfitool.Components.extend("_base", "html/textinput", {
    name: "Input",
	nodes: ["input"],
...
Isfitool.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						Isfitool.Components.render("html/selectinput");
						return node;
					}
...
Isfitool.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: "icons/text_area.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>'
});
Isfitool.Components.extend("_base", "html/radiobutton", {
    name: "Radio Button",
...
Isfitool.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
...
Isfitool.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
Isfitool.Components.extend("_base", "html/table", {
    nodes: ["table"],
    classes: ["table"],
...
Isfitool.Components.extend("_base", "html/tablerow", {
    nodes: ["tr"],
    name: "Table Row",
...
Isfitool.Components.extend("_base", "html/tablecell", {
    nodes: ["td"],
    name: "Table Cell",
    html: "<td>Cell</td>"
});
Isfitool.Components.extend("_base", "html/tableheadercell", {
    nodes: ["th"],
    name: "Table Header Cell",
    html: "<th>Head</th>"
});
Isfitool.Components.extend("_base", "html/tablehead", {
    nodes: ["thead"],
    name: "Table Head",
...
Isfitool.Components.extend("_base", "html/tablebody", {
    nodes: ["tbody"],
    name: "Table Body",
    html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

Isfitool.Components.add("html/gridcolumn", {
    name: "Grid Column",
...
Isfitool.Components.add("html/gridrow", {
    name: "Grid Row",
    image: "icons/grid_row.svg",
    classes: ["row"],
		...
		$(node).find('[class*="col-"]').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						column.remove();
						Isfitool.Components.render("html/gridrow");
						return node;
					}
...
Isfitool.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
...
Isfitool.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    ...
    dragHtml: '<img  width="320" height="240" src="' + Isfitool.baseUrl + 'icons/video.svg">',
