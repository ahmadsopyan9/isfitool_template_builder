...
<html lang="en">
  <head>
    ...
    <base href="">
    <title>Isfitool Template Builder</title>
...
<body>
	...
	<div id="isfitool-builder">
				
				<div id="top-panel">
					<img src="img/logo.png" alt="isfitool" class="float-left bg-primary" id="logo" style="margin-top:-8px;">
					
					
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-isfitool-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button>

					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-isfitool-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-isfitool-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="libs/builder/icons/right-column-layout.svg" width="20px" height="20px">
					  </button>
					</div>
										
					<div class="btn-group mr-3" role="group">
					  <button class="btn btn-light" title="Undo (Ctrl/Cmd + Z)" id="undo-btn" data-isfitool-action="undo" data-isfitool-shortcut="ctrl+z">
						  <i class="la la-undo"></i>
					  </button>

					  <button class="btn btn-light"  title="Redo (Ctrl/Cmd + Shift + Z)" id="redo-btn" data-isfitool-action="redo" data-isfitool-shortcut="ctrl+shift+z">
					...
					<div class="btn-group mr-3" role="group">
					  <button class="btn btn-light" title="Designer Mode (Free component dragging)" id="designer-mode-btn" data-toggle="button" aria-pressed="false" data-isfitool-action="setDesignerMode">
						  <i class="la la-hand-grab-o"></i>
					  </button>

					  <button class="btn btn-light" title="Preview" id="preview-btn" type="button" data-toggle="button" aria-pressed="false" data-isfitool-action="preview">
						  <i class="la la-eye"></i>
					  </button>

					  <button class="btn btn-light" title="Fullscreen (F11)" id="fullscreen-btn" data-toggle="button" aria-pressed="false" data-isfitool-action="fullscreen">
					...
					<div class="btn-group mr-3" role="group">
					  <button class="btn btn-light" title="Export (Ctrl + E)" id="save-btn" data-isfitool-action="saveAjax" data-isfitool-shortcut="ctrl+e">
						  <i class="la la-save"></i>
					  </button>
					  
					  <button class="btn btn-light" title="Download" id="download-btn" data-isfitool-action="download" data-download="index.html">
					...
					<div class="btn-group float-right responsive-btns" role="group">
		 			 <button id="mobile-view" data-view="mobile" class="btn btn-light"  title="Mobile view" data-isfitool-action="viewport">
						  <i class="la la-mobile-phone"></i>
					  </button>

					  <button id="tablet-view"  data-view="tablet" class="btn btn-light"  title="Tablet view" data-isfitool-action="viewport">
						  <i class="la la-tablet"></i>
					  </button>
					  
					  <button id="desktop-view"  data-view="" class="btn btn-light"  title="Desktop view" data-isfitool-action="viewport">
							...
							<div class="header">
								<a href="#" class="text-secondary">Pages</a>
									...
									<div class="btn-group responsive-btns mr-4 float-right" role="group">
									  <button class="btn btn-link btn-sm" title="New file" id="new-file-btn" data-isfitool-action="newPage" data-isfitool-shortcut="">
										  <i class="la la-file"></i> <small>New page</small>
									  </button>
									  
									  <!--  &ensp;
									  <button class="btn btn-link text-dark p-0"  title="Delete file" id="delete-file-btn" data-isfitool-action="deletePage" data-isfitool-shortcut="">
						...
						<div class="header">							
							...
							<div class="tab-content">
							  <div class="tab-pane fade show active" id="components" role="tabpanel" aria-labelledby="components-tab">
								   ...
								   <div class="search">
										  <input class="form-control form-control-sm component-search" placeholder="Search components" type="text" data-isfitool-action="componentSearch" data-isfitool-on="keyup">
										  <button class="clear-backspace"  data-isfitool-action="clearComponentSearch">
							  ...
							  <div class="tab-pane fade" id="blocks" role="tabpanel" aria-labelledby="blocks-tab">
								   ...
								   <div class="search">
										  <input class="form-control form-control-sm block-search" placeholder="Search blocks" type="text" data-isfitool-action="blockSearch" data-isfitool-on="keyup">
										  <button class="clear-backspace"  data-isfitool-action="clearBlockSearch">
											  <i class="la la-close"></i>
										  </button>
									  </div>
									...
									<div class="header">							
										...
										<div class="tab-content">
										  <div class="tab-pane fade show active" id="box-components" role="tabpanel" aria-labelledby="components-tab">
											   ...
											   <div class="search">
													  <input class="form-control form-control-sm component-search" placeholder="Search components" type="text" data-isfitool-action="addBoxComponentSearch" data-isfitool-on="keyup">
													  <button class="clear-backspace"  data-isfitool-action="clearComponentSearch">
														  <i class="la la-close"></i>
													  </button>
												  </div>
										  ...
										  <div class="tab-pane fade" id="box-blocks" role="tabpanel" aria-labelledby="blocks-tab">
											   ...
											   <div class="search">
													  <input class="form-control form-control-sm block-search" placeholder="Search blocks" type="text" data-isfitool-action="addBoxBlockSearch" data-isfitool-on="keyup">
													  <button class="clear-backspace"  data-isfitool-action="clearBlockSearch">
														  <i class="la la-close"></i>
													  </button>
												  </div>
				...
				<div class="btn-group" role="group">
		 			 ...
		 			 <button id="code-editor-btn" data-view="mobile" class="btn btn-sm btn-light btn-sm"  title="Code editor" data-isfitool-action="toggleEditor">
						...
						<div id="toggleEditorJsExecute" class="custom-control custom-checkbox mt-1" style="display:none">
							<input type="checkbox" class="custom-control-input" id="customCheck" name="example1" data-isfitool-action="toggleEditorJsExecute">
							<label class="custom-control-label" for="customCheck"><small>Run javascript code on edit</small></label>
						</div>
					</div>
					
					<div id="isfitool-code-editor">
...
<script id="isfitool-input-textinput" type="text/html">
...
<script id="isfitool-input-textareainput" type="text/html">
...
<script id="isfitool-input-checkboxinput" type="text/html">
...
<script id="isfitool-input-radioinput" type="text/html">
...
<script id="isfitool-input-radiobuttoninput" type="text/html">
...
<script id="isfitool-input-toggle" type="text/html">
...
<script id="isfitool-input-header" type="text/html">
...
<script id="isfitool-input-select" type="text/html">
...
<script id="isfitool-input-listinput" type="text/html">
...
<script id="isfitool-input-grid" type="text/html">
...
<script id="isfitool-input-textvalue" type="text/html">
...
<script id="isfitool-input-rangeinput" type="text/html">
...
<script id="isfitool-input-imageinput" type="text/html">
...
<script id="isfitool-input-colorinput" type="text/html">
...
<script id="isfitool-input-bootstrap-color-picker-input" type="text/html">
...
<script id="isfitool-input-numberinput" type="text/html">
	<div>
...
<script id="isfitool-input-button" type="text/html">
	<div>
...
<script id="isfitool-input-cssunitinput" type="text/html">
...
<script id="isfitool-filemanager-folder" type="text/html">
...
<script id="isfitool-filemanager-page" type="text/html">
...
<script id="isfitool-filemanager-component" type="text/html">
	<li data-url="{%=url%}" data-component="{%=name%}" class="component">
		<a href="{%=url%}"><span>{%=title%}</span></a>
	</li>
</script>

<script id="isfitool-input-sectioninput" type="text/html">
...
<script id="isfitool-property" type="text/html">
...
<script id="isfitool-input-autocompletelist" type="text/html">
...
<div class="modal fade" id="message-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <p class="modal-title text-primary"><i class="la la-lg la-comment"></i> isfitoolJs</p>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><small><i class="la la-close"></i></small></span>
        </button>
      </div>
			...
			<div class="col-sm-9 input">
				<div>    
					<select class="form-control custom-select" name="startTemplateUrl">        
						...
						<option value="dpage/narrow-jumbotron/index.html">Narrow jumbotron</option>       
						<option value="dpage/album/index.html">Album</option>       
					</select>    
				</div>
			</div>     
		</div>
...
$(document).ready(function() 
{
	...
	{
		$("#isfitool-builder").addClass("no-right-panel");
		$(".component-properties-tab").show();
		Isfitool.Components.componentPropertiesElement = "#left-panel .component-properties";
	} else
	{
		$(".component-properties-tab").hide();
	}

	Isfitool.Builder.init('dpage/narrow-jumbotron/index.html', function() {
		//run code after page/iframe is loaded
	});

	Isfitool.Gui.init();
	Isfitool.FileManager.init();
	Isfitool.FileManager.addPages(
	[
		{name:"narrow-jumbotron", title:"Jumbotron",  url: "dpage/narrow-jumbotron/index.html", assets: ['dpage/narrow-jumbotron/narrow-jumbotron.css']},
		{name:"landing-page", title:"Landing page",  url: "dpage/startbootstrap-landing-page/index.html", assets: ['dpage/startbootstrap-landing-page/css/landing-page.min.css']},
		{name:"album", title:"Album",  url: "dpage/album/index.html", folder:"content", assets: ['dpage/album/album.css']},
		{name:"blog", title:"Blog",  url: "dpage/blog/index.html", folder:"content", assets: ['dpage/blog/blog.css']},
		{name:"carousel", title:"Carousel",  url: "dpage/carousel/index.html", folder:"content", assets: ['dpage/carousel/carousel.css']},
		{name:"offcanvas", title:"Offcanvas",  url: "dpage/offcanvas/index.html", folder:"content", assets: ['dpage/offcanvas/offcanvas.css','dpage/offcanvas/offcanvas.js']},
		{name:"pricing", title:"Pricing",  url: "dpage/pricing/index.html", folder:"ecommerce", assets: ['dpage/pricing/pricing.css']},
		{name:"product", title:"Product",  url: "dpage/product/index.html", folder:"ecommerce", assets: ['dpage/product/product.css']},
	...
	Isfitool.FileManager.loadPage("narrow-jumbotron");
});
</script>
</body>
</html>
